...
GO
/****** Object:  ONLIMS StoredProcedure [dbo].[QS_Reception_Trucks]    Script Date: 24/01/2025 20:13:29 ******/
SET ANSI_NULLS ON
GO
...
and f.WHSE_ID = @as_WHID
and s.SampleTm  between @idIniDate and @idFinDate
and F.NetWeight is not null --- Pesos NETo
--and F.LeaveDate is not null
